      ...
      <div className="flex h-full flex-col justify-between">
        <div>
          ...
          <p className="mt-2 text-justify text-sm">
            ...
            hacer buen uso del mismo y devolverlo antes del <span className="underline">{prestamoFechaFinHumano}</span>.
            De requerir una extensión de plazo, me comprometo a presentarme en el departamento de electrónica a los
            efectos de solicitar la renovación correspondiente. Asi mismo delcaro que mi datos personales figuran
            correctamente.
          </p>
        </div>
        <div>
