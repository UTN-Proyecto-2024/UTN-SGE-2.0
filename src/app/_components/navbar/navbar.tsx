...
const DesktopProfileMenu = (user: Session["user"]) => (
  <Menu as="div" className="relative ml-3">
    <div>
      <MenuButton className="relative flex w-6 items-center rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
