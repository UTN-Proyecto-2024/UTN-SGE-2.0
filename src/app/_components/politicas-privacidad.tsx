...
export const PoliticasPrivacidadModal = ({ triggerText }: { triggerText: string }) => {
  ...
  return (
    ...
    >
      <ScrollArea className="max-h-[64vh] w-full pr-4">
            ...
            <div className="flex w-full flex-col gap-4">
              ...
              <div>
                ...
                <ol className="flex list-inside list-decimal flex-col gap-4">
                  <li>
                    <p className="text-sm text-black">
                      Tendrá prioridad de asignación el pedido de reserva que involucre la realización de una práctica
                      que incluya el uso de instrumental (ya sea de equipos o PC&apos;s) propio del Departamento, dado
                      que lógicamente el único ámbito donde la misma podrá efectuarse son las instalaciones propias.
                    </p>
                  </li>
                  <li>
                    <p className="text-sm text-black">
                      Se dará prioridad a aquellos cursos que, al momento de la asignación, hayan hecho un menor uso de
                      los laboratorios, a fin de equiparar la distribución en la utilización de los recursos
                      disponibles.
                    </p>
                  </li>
                  <li>
                    <p className="text-sm text-black">
                      ...
                      necesario, el Departamento cuenta en cada sede con un cañón extra que podrá ser prestado al
                      docente que lo solicite para el dictado de la clase en un aula externa.
                    </p>
                  </li>
                </ol>
              </div>
                ...
                <ol className="flex list-inside list-decimal flex-col gap-4">
                  <li>
                    <p className="text-sm text-black">
                      ...
                      horario extra académico en caso en que lo hayan solicitado por los medios de reserva disponibles.
                      Si hubiese lugar disponible en los mismos, los Laboratorios Abiertos podrán utilizarse para
                      atención de consultas y corrección de proyectos por parte del cuerpo docente, previa solicitud al
                      personal de Pañol, y teniendo en cuenta que los mismos no cuentan con la capacidad de un
                      laboratorio aula.
                    </p>
                  </li>
                  <li>
                    <p className="text-sm text-black">
                      Los laboratorios pertenecientes al Departamento no están asignados de manera fija a ninguna
                      materia de la carrera. Por una cuestión administrativa, la Subsecretaría de Gestión suele
                      solicitar al inicio de cada año una cantidad de laboratorios para distribución de cursos debido a
                      la superpoblación reinante, y por una cuestión de orden bedelía asigna uno u otro curso. Debe
                      entenderse que la utilización de los laboratorios está supeditada a los puntos antes mencionados,
                      y los mismos son evaluados por el personal responsable del Departamento, motivo por el cual es
                      indispensable realizar la reserva de laboratorio pertinente independientemente de lo publicado por
                      bedelía, pudiendo luego variar el lugar de dictado de la clase (aula o laboratorio) en función de
                      la disponibilidad.
                    </p>
                  </li>
                  <li>
                  ...
                  <li>
                    <p className="text-sm text-black">
                      Se recomienda a los docentes efectuar las reservas de laboratorio con un plazo mínimo de una
                      semana de anticipación, por los motivos citados en el punto anterior, dado que a pesar que su
                      curso tenga una menor utilización del laboratorio, no se podrá dar de baja una reserva sin cumplir
                      con el plazo de aviso previo estipulado, por respeto a las demás cétedras.
                    </p>
                  </li>
                  <li>
                    <p className="text-sm text-black">
